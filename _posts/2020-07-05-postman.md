---
layout: post
title: "Getting the Most out of Postman"
date: 2020-07-05
category: Testing
tags: [Testing]
comments: true
...
Variables allow you to parameterise requests and are key-value pairs. You can recognise them in a collection by the curly braces. The variables can be in a URI, in header parameters or in the body of a request. For example:

~~~
{{HOST}}/document/{{UNID_0}}/default?db=demo
~~~

---
layout: post
title: "Postman: The Crucial Tool for Any Microservice Developer"
date: 2023-07-15
category: domino
tags: [domino,domino-rest-api,lotusscript,voltscript]
comments: true
---
My history with REST development is long. In 2018, before I joined HCL, I delivered a session "Domino and JavaScript Development Masterclass" at IBM Think. When I posted about [my development tools in 2017](https://paulswithers.github.io/blog/2017/05/26/my-dev-tools-2), Postman - then just a Chrome plugin - was key amongst them. Then in 2020 I posted an [overview of Postman](https://paulswithers.github.io/blog/2020/07/05/postman). And just as both John and I used Postman as a crucial tool when building the application we showed at our session at IBM Think, it's the tool that should be used by anyone doing anything with microservices - which is what every scope your create for Domino REST API is.

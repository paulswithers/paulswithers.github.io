---
layout: post
title: "JSON handling in XPages"
date: 2020-02-27
category: domino
tags: [xpages, domino, vert.x]
comments: true
---
...
Those who haven't stepped into the arcane world of [Stephan Wissel](https://www.wissel.net/blog/categories/vertx.html) and I may be unfamiliar with [Vert.x](https://vertx.io/). We'll cover it at [Engage](https://engage.ug) next week in our sessions, because it's at the heart of Project Keep. But in essence it's an **open source** multi-modular lightweight polyglot framework. One of those languages is [Java](https://vertx.io/docs/vertx-core/java/) and in the core APIs is JSON handling. The [documentation](https://vertx.io/docs/vertx-core/java/#_json) has an introduction into JSON in Vert.x or if you prefer a JavaDoc, of course there are [Javadocs](https://vertx.io/docs/apidocs/).

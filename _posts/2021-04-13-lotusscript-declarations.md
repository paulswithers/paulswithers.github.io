---
layout: post
title: "LotusScript Declarations"
date: 2021-04-13
category: Domino
tags: [domino,lotusscript]
comments: true
---
...
This suggested the actual cause of the problem, that for some reason there was some problem coverting the forall variable to a string, because the same variable name was used for two loops. Sure enough, changing the forall variable name in one of the loops solved the problem.

---
layout: post
title: "My Development Tools - Part Two: Beyond Domino"
date: 2017-05-26
comments: true
---

Following on from my [last blog post](/posts/2017-04-26-my-dev-tools) it's now time to move on beyond the tooling related to Domino and XPages.
...
#### Docker
But on my new laptop I can run Docker, so I've installed the Swagger Editor using the Docker image, which is much easier. Docker itself is easy to set up and ocne that's running, two lines of code will start the docker image of Swagger Editor.
